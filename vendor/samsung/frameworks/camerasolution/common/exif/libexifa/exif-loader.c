...
/* Parsing APP1 that comes after APP4
   2015.10.14 - Samsung Electronics */
                          ...
                          unsigned int *buf_size)
{
    ...
    if (!loader || (loader->data_format == EL_DATA_FORMAT_UNKNOWN)) {
        /* Fix possible null pointer dereference.
           2012.05.25 - Samsung Electronics */
        if(loader) exif_log (loader->log, EXIF_LOG_CODE_DEBUG, "ExifLoader",
