...
public abstract class KeyStoreSpi {
     ...
     * @hide
     */
    public Enumeration<String> engineList(int mode) {
     ...
     * @hide
     */
    public Enumeration<String> engineList(String prefix, String name) {
        throw new UnsupportedOperationException();
    }
     ...
     * @hide
     */
    public boolean engineContainsAlias(String prefix, String name) {
        throw new UnsupportedOperationException();
    }
     ...
     * @hide
     */
    public boolean engineContainsUniquePrivateKey(String name) {
        throw new UnsupportedOperationException();
    }
     ...
     * @hide
     */
    public String engineRetrieveUniquePrivateKeyAlias(String name) {
        throw new UnsupportedOperationException();
    }
     ...
     * @hide
     */
    public byte[] engineGetCSR(String alias) {
        throw new UnsupportedOperationException();
    }
